...
\begin{enumerate}[a)]
	\item A Simple Majority vote by Members attending an AGM or SGM, or
...
\begin{enumerate}[a)]
	...
	\item Suspension will be confirmed upon an Absolute Majority vote by the Committee, with the exception of the suspended OCM.
	\begin{enumerate}[i)]
...
\begin{enumerate}[a)]
	...
	\item An Absolute Majority vote by the Committee, with the exception of the OCM being considered for removal:
	\begin{enumerate}[i)]
...
\begin{enumerate}[a)]
	...
	\item The OCM will be restored to their position upon an Absolute Majority vote by the Committee.
	\begin{enumerate}[i)]
...
\section{Removal of Executive Committee Members}
...
Quorum for the AGM shall be twenty (20) Members or an Absolute Majority of the listed Members, whichever is fewer.
...
Quorum for an SGM shall be twenty (20) Members or an Absolute Majority of the current membership, whichever is fewer.
